...
import { PhoneFrame, ScreenHome, ScreenRecord, ScreenHistory } from './app-preview'
import { cn } from '../../lib/cn'

const SCREENS = [
  { key: 'home', label: 'Home', screen: <ScreenHome />, lift: false },
  { key: 'record', label: 'Record', screen: <ScreenRecord />, lift: true },
  { key: 'history', label: 'History', screen: <ScreenHistory />, lift: false },
]
...
export function AppPreviewSection() {
  return (
    <SectionShell
      ...
      intro="Real Ballista app screens: capture a swing, let computer vision detect it, and review movement metrics and session history afterward."
      centered
    >
      <Reveal>

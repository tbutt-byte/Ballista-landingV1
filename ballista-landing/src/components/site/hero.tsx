      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl px-6">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          >
            ...
            phone-based swing tracking · no hardware
          </motion.div>
          ...
          >
            Ballista uses phone-based computer vision to help players measure swing movement, review
            key metrics, and see progress over time.
          </motion.p>

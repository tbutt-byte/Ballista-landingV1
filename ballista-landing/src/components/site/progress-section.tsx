      ...
      <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
        <Reveal>
          ...
          <p className="mt-5 text-base leading-relaxed text-white/60 md:text-lg">
            A single swing is a snapshot. Ballista keeps your sessions together so players, parents,
            and coaches can see how movement changes over time — not just on one good day.
          </p>
        ...
        <Reveal delay={0.1}>
          <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-7">
            <div className="flex items-baseline justify-between">
              <span className="text-sm font-medium text-white">Hand speed trend</span>
